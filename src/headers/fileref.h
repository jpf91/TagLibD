...
%feature("director") FileTypeResolver;
    ...
    public:
      ...
      virtual TagLib::File *createFile(TagLib::FileName fileName,
                               ...
                               audioPropertiesStyle = TagLib::AudioProperties::Average) const = 0;
    };
    %nestedworkaround TagLib::FileRef::FileTypeResolver;
%{
...
namespace TagLib {
   ...
   */
  %feature("nspace") FileRef;
  %rename("CPP_FileRef") FileRef;
