...
namespace TagLib {
   ...
   */
  %feature("nspace") AudioProperties;
  ...
  public:
     ...
     */
    %dmethodmodifiers length "@property";
     ...
     */
    %dmethodmodifiers bitrate "@property";
    virtual int bitrate() const = 0;

    /*!
     * Returns the sample rate in Hz.
     */
    %dmethodmodifiers sampleRate "@property";
    virtual int sampleRate() const = 0;

    /*!
     * Returns the number of audio channels.
     */
    %dmethodmodifiers channels "@property";
