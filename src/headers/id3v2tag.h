...
namespace TagLib {
  ...
  namespace ID3v2 {
    ...
    class FrameFactory;
    class Frame;
    %template(frameList) ::TagLib::List<Frame *>;
    typedef List<Frame *> FrameList;
    //%template(frameListMap) TagLib::Map<TagLib::ByteVector, FrameList>;
    ...
    public:
      ...
      Tag(File *file, long tagOffset,
          const TagLib::ID3v2::FrameFactory *factory = TagLib::ID3v2::FrameFactory::instance());
    ...
    %dmethodmodifiers setYear "@property";
       ...
       */
      TagLib::ID3v2::Header *header() const;

      /*!
       * Returns a pointer to the tag's extended header or null if there is no
       * extended header.
       */
      TagLib::ID3v2::ExtendedHeader *extendedHeader() const;
       ...
       * release.
       */
      TagLib::ID3v2::Footer *footer() const;
       ...
       * \see frameList()
       */
      const TagLib::ID3v2::FrameListMap &frameListMap() const;
       ...
       * use addFrame() and removeFrame().
       */
      const TagLib::ID3v2::FrameList &frameList() const;
       ...
       * \see frameListMap()
       */
      const TagLib::ID3v2::FrameList &frameList(const ByteVector &frameID) const;
       ...
       */
      void addFrame(TagLib::ID3v2::Frame *frame);
       ...
       * returned by frameList()
       */
      void removeFrame(TagLib::ID3v2::Frame *frame, bool del = true);
